...
?>
    ...
    <body>
        ...
        <header id="header">
            <div class="d-flex flex-column">
                <div class="profile">
                    ...
                    ?>
                            <br>
                            <h1 class="text-light"><a href="dashboard_user.php"><i class="fas fa-user-circle"></i>
                ...
                <nav class="nav-menu">
                    <ul>
                        ...
                        <li><a href="#about"><i class="far fa-user"></i> <span>Personal Details</span></a></li>
                        ...
                        <li><a href="#experiance"><i class="fas fa-briefcase"></i> Work Experience</a></li>
        ...
        <main id="main">
            ...
            <section id="about" class="about">
                ...
                if(mysqli_num_rows($result) == 0){?>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <a href="personal_details.php" class="btn btn-primary text-center">Make Your Portfolio</a>
                        </div>
                    </div>
                <?php   }else{
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <ul>
                                        <li><i class="icofont-rounded-right"></i> <strong><i class="fas fa-birthday-cake"></i> Birthday:&nbsp;</strong>
                                            <?php echo $row['pd_dob']; ?>
                                        </li>
                                        ...
                                        <li><i class="icofont-rounded-right"></i> <strong><i class="fas fa-volleyball-ball"></i> Hobbies:&nbsp;</strong>
        ...
        <footer id="footer">
            <div class="container">
                <div class="copyright">
                    &copy; Copyright <strong><span>Connectify</span></strong>
                </div>
            </div>
        </footer><!-- End  Footer -->
