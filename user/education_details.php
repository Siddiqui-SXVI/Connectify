		            ...
		            <div class="col-md-4 py-5 bg-primary text-white text-center ">
		                <div class=" ">
		                    <div class="card-body">
		                        ...
		                        <p class="text-white">Welcome to the Connectify. This is the educational details page for creating your own portfolio for the better experience.</p>
		                    </div>
		                </div>
		            </div>
		            <div class="col-md-8 py-5 border">
		                ...
		                <h1 class="pb-4 text-warning">Educational Details</h1>
		                    ...
		                    <div class="form-row">
								...
								<a href="experience_details.php" class="btn btn-danger text-center">NEXT</a><br><br>
		                    </div>
		            </div>
	        </div>
   		</form>
