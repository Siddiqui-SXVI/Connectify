		            ...
		            <div class="col-md-4 py-5 bg-primary text-white text-center ">
		                <div class=" ">
		                    <div class="card-body">
		                        ...
		                        <p class="text-white">Welcome to the Connectify. This is the achievement details page for creating your own portfolio for the better experience.</p>
		                ...
		                <h1 class="pb-4 text-warning">Achievement Details</h1>
		                    ...
		                    <div class="form-row">
			                        ...
			                        <div class="col-md-12 form-group">
			                        	<label class="text-warning">Achievement Certificate</label>
		                    ...
		                    <div class="form-row">
								...
								<a href="dashboard_user.php" class="btn btn-danger">NEXT</a>
		                    </div>
		            </div>
	        </div>
   		</form>
