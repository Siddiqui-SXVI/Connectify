		            ...
		            <div class="col-md-4 py-5 bg-primary text-white text-center ">
		                <div class=" ">
		                    <div class="card-body">
		                        ...
		                        <p class="text-white">Welcome to the Connectify. This is the personal details page for creating your own portfolio for the better experience.</p>
		                    </div>
		                </div>
		            </div>
		            <div class="col-md-8 py-5 border">
		                ...
		                <h1 class="pb-4 text-warning">Personal Details</h1>
		                    ...
		                    <div class="form-row">
		                     ...
		                     <div class="form-row">
			                	<textarea class="form-control" id="add" rows="3" placeholder="Residential Address" name="add"></textarea> 
		                    </div>
		                    <br>
