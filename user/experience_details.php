...
<section class="testimonial py-5" id="testimonial">
    <div class="container">
    	<form method="post" action="add_experience_details.php" enctype="multipart/form-data">
	        <div class="row ">
		            <div class="col-md-4 py-5 bg-primary text-white text-center ">
		                <div class=" ">
		                    <div class="card-body">
		                        <img src="img/symbol.png" style="width:30%" title="Connectify">
		                        <h2 class="py-3 text-warning">Experience Details</h2>
		                        <p class="text-white">Welcome to the Connectify. This is the experience details page for creating your own portfolio for the better experience.</p>
		            ...
		            <div class="col-md-8 py-5 border">
						...
						?>
		                <h1 class="pb-4 text-warning">Experience Details</h1>
		                    ...
		                    <div class="form-row">	
		                        ...
		                        <?php 
		                        	if (isset($_SESSION['temp_user'])) {
		                        		...
		                        		$query=mysqli_query($con,"select * from reg_users where reg_email='$uname'");
		                    ...
		                    <div class="form-row">
			                        <div class="form-group col-md-12">
			                        	<input type="text" name="work_name" placeholder="Designation" class="form-control" required="">
			                        </div>
		                    ...
		                    <div class="form-row">
								...
								<a href="project_details.php" class="btn btn-danger">NEXT</a>
		                    </div>
		            </div>
	        </div>
   		</form>
