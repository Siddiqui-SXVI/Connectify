<?php 
	...
	$q = "select * from work_experience_detail where we_id='$id'";
	$result = $con->query($q);
    	...
    	<form method="post" action="update_ex.php" enctype="multipart/form-data">
	        <div class="row ">
		            <div class="col-md-4 py-5 bg-primary text-white text-center ">
		                <div class=" ">
		                    <div class="card-body">
		                        ...
		                        <h2 class="py-3 text-warning">Work Experience Details</h2>
		            ...
		            <div class="col-md-8 py-5 border">
		                ...
		                <h1 class="pb-4 text-warning">Work Experience Details</h1>
