            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    <table class="table table-bordered" id="pdDT">
                        ...
                        <tbody>
                            <?php  
                              $q1 = "select * from personal_detail pd,reg_users rd where pd.reg_id=rd.reg_id";
                              $result = $con->query($q1);
                              $count=1;
                            ...
                            <tr>
                              ...
                              <td><img style="width: 100px;height: 10%;" src="../user/profile/<?php echo $row['pd_profile']; ?>"></td>
