            ...
            <section class="panel">
                ...
                <div class="panel-body">
                       <table class="table table-bordered" id="pdDT">
                        ...
                        <tbody>
                            <?php  
                              $q1 = "select * from achievement_details ad,reg_users rd where ad.reg_id=rd.reg_id order by reg_name asc";
                              $result = $con->query($q1);
                              $count=1;
                            ...
                            <tr>
                                ...
                                <td><img style="width: 100px;height: 10%;" src="../user/certificates/<?php echo $row['ach_certy']; ?>"></td>
