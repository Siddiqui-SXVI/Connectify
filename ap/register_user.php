              ...
              <div class="row state-overview">
                  ...
                  <div class="col-lg-3 col-sm-6">
                      <section class="panel">
                          ...
                          <div class="value">
                            <?php  
                                $query = "select count(reg_id) as total from reg_users";
                  ...
                  <div class="col-lg-3 col-sm-6">
                      <section class="panel">
                          ...
                          <div class="value">
                                <?php  
                                    $query_status = "select count(login_status) from reg_users where login_status='1'";
                  ...
                  <div class="col-lg-3 col-sm-6">
                      <section class="panel">
                          ...
                          <div class="value">
                                <?php  
                                    $query_today = "select count(reg_id) from reg_users where DATE(reg_date) = DATE(NOW())";
                  ...
                  <div class="col-lg-3 col-sm-6">
                      <section class="panel">
                          ...
                          <div class="value">
                                <?php  
                                    $query_today = "select count(reg_id) from reg_users where login_status=1";
                                    $result_today = mysqli_query($con,$query_today);
                                    $row_today = mysqli_fetch_array($result_today);
                                    $count_today = $row_today[0];
                                ?>
                  ...
                  <div class="alert alert-block alert-success fade in">
                    ...
                    <table class="table table-bordered" id="redDT">
                        <thead>
                         ...
                         <?php  
                                $fetch_ed = "select * from reg_users";
                            ...
                            <tr>
                                ...
                                <td>
                                  <?php  
                                    ...
                                    {
                                    ?>
                                  <a href="block_status.php?q=<?php echo base64_encode($row['reg_id']); ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i>&nbsp;Delete</a>
                                   <?php }
                                    //else{
                                  ?>
